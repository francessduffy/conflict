...
from app.model.results import printing
...
# COMMENTS JUST SO I KNOW WHERE THIS STOPS!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# COMMENTS JUST SO I KNOW WHERE THIS STOPS!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# COMMENTS JUST SO I KNOW WHERE THIS STOPS!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# COMMENTS JUST SO I KNOW WHERE THIS STOPS!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# COMMENTS JUST SO I KNOW WHERE THIS STOPS!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
def testing():
    ...
    avestrength1 = [(a) for a in zip(*allstrength1)]
    avenotorietyratio1 = [(a) for a in zip(*allnotorietyratio1)]
    avetotalextort1 = [(a) for a in zip(*alltotalextort1)]
    avecountextort1 = [(a) for a in zip(*allcountextort1)]
    avecountbenefit1 = [(a) for a in zip(*allcountbenefit1)]
    avecountpunish1 = [(a) for a in zip(*allcountpunish1)]
    avecountsupport1 = [(a) for a in zip(*allcountsupport1)]
    avetotalsupport1 = [(a) for a in zip(*alltotalsupport1)]
    avecountdefend1 = [(a) for a in zip(*allcountdefend1)]

    avestrength2 = [(a) for a in zip(*allstrength2)]
    avenotorietyratio2 = [(a) for a in zip(*allnotorietyratio2)]
    avetotalextort2 = [(a) for a in zip(*alltotalextort2)]
    avecountextort2 = [(a) for a in zip(*allcountextort2)]
    avecountbenefit2 = [(a) for a in zip(*allcountbenefit2)]
    avecountpunish2 = [(a) for a in zip(*allcountpunish2)]
    avecountsupport2 = [(a) for a in zip(*allcountsupport2)]
    avetotalsupport2 = [(a) for a in zip(*alltotalsupport2)]
    avecountdefend2 = [(a) for a in zip(*allcountdefend2)]

    avestrength3 = [(a) for a in zip(*allstrength3)]
    avenotorietyratio3 = [(a) for a in zip(*allnotorietyratio3)]
    avetotalextort3 = [(a) for a in zip(*alltotalextort3)]
    avecountextort3 = [(a) for a in zip(*allcountextort3)]
    avecountbenefit3 = [(a) for a in zip(*allcountbenefit3)]
    avecountpunish3 = [(a) for a in zip(*allcountpunish3)]
    avecountsupport3 = [(a) for a in zip(*allcountsupport3)]
    avetotalsupport3 = [(a) for a in zip(*alltotalsupport3)]
    avecountdefend3 = [(a) for a in zip(*allcountdefend3)]

    avestrength4 = [(a) for a in zip(*allstrength4)]
    avenotorietyratio4 = [(a) for a in zip(*allnotorietyratio4)]
    avetotalextort4 = [(a) for a in zip(*alltotalextort4)]
    avecountextort4 = [(a) for a in zip(*allcountextort4)]
    avecountbenefit4 = [(a) for a in zip(*allcountbenefit4)]
    avecountpunish4 = [(a) for a in zip(*allcountpunish4)]
    avecountsupport4 = [(a) for a in zip(*allcountsupport4)]
    avetotalsupport4 = [(a) for a in zip(*alltotalsupport4)]
    avecountdefend4 = [(a) for a in zip(*allcountdefend4)]

    avestrength5 = [(a) for a in zip(*allstrength5)]
    avenotorietyratio5 = [(a) for a in zip(*allnotorietyratio5)]
    avetotalextort5 = [(a) for a in zip(*alltotalextort5)]
    avecountextort5 = [(a) for a in zip(*allcountextort5)]
    avecountbenefit5 = [(a) for a in zip(*allcountbenefit5)]
    avecountpunish5 = [(a) for a in zip(*allcountpunish5)]
    avecountsupport5 = [(a) for a in zip(*allcountsupport5)]
    avetotalsupport5 = [(a) for a in zip(*alltotalsupport5)]
    avecountdefend5 = [(a) for a in zip(*allcountdefend5)]

    avestrength6 = [(a) for a in zip(*allstrength6)]
    avenotorietyratio6 = [(a) for a in zip(*allnotorietyratio6)]
    avetotalextort6 = [(a) for a in zip(*alltotalextort6)]
    avecountextort6 = [(a) for a in zip(*allcountextort6)]
    avecountbenefit6 = [(a) for a in zip(*allcountbenefit6)]
    avecountpunish6 = [(a) for a in zip(*allcountpunish6)]
    avecountsupport6 = [(a) for a in zip(*allcountsupport6)]
    avetotalsupport6 = [(a) for a in zip(*alltotalsupport6)]
    avecountdefend6 = [(a) for a in zip(*allcountdefend6)]

    avestrength7 = [(a) for a in zip(*allstrength7)]
    avenotorietyratio7 = [(a) for a in zip(*allnotorietyratio7)]
    avetotalextort7 = [(a) for a in zip(*alltotalextort7)]
    avecountextort7 = [(a) for a in zip(*allcountextort7)]
    avecountbenefit7 = [(a) for a in zip(*allcountbenefit7)]
    avecountpunish7 = [(a) for a in zip(*allcountpunish7)]
    avecountsupport7 = [(a) for a in zip(*allcountsupport7)]
    avetotalsupport7 = [(a) for a in zip(*alltotalsupport7)]
    avecountdefend7 = [(a) for a in zip(*allcountdefend7)]

    avestrength8 = [(a) for a in zip(*allstrength8)]
    avenotorietyratio8 = [(a) for a in zip(*allnotorietyratio8)]
    avetotalextort8 = [(a) for a in zip(*alltotalextort8)]
    avecountextort8 = [(a) for a in zip(*allcountextort8)]
    avecountbenefit8 = [(a) for a in zip(*allcountbenefit8)]
    avecountpunish8 = [(a) for a in zip(*allcountpunish8)]
    avecountsupport8 = [(a) for a in zip(*allcountsupport8)]
    avetotalsupport8 = [(a) for a in zip(*alltotalsupport8)]
    avecountdefend8 = [(a) for a in zip(*allcountdefend8)]

    avestrength9 = [(a) for a in zip(*allstrength9)]
    avenotorietyratio9 = [(a) for a in zip(*allnotorietyratio9)]
    avetotalextort9 = [(a) for a in zip(*alltotalextort9)]
    avecountextort9 = [(a) for a in zip(*allcountextort9)]
    avecountbenefit9 = [(a) for a in zip(*allcountbenefit9)]
    avecountpunish9 = [(a) for a in zip(*allcountpunish9)]
    avecountsupport9 = [(a) for a in zip(*allcountsupport9)]
    avetotalsupport9 = [(a) for a in zip(*alltotalsupport9)]
    avecountdefend9 = [(a) for a in zip(*allcountdefend9)]

    avestrength10 = [(a) for a in zip(*allstrength10)]
    avenotorietyratio10 = [(a) for a in zip(*allnotorietyratio10)]
    avetotalextort10 = [(a) for a in zip(*alltotalextort10)]
    avecountextort10 = [(a) for a in zip(*allcountextort10)]
    avecountbenefit10 = [(a) for a in zip(*allcountbenefit10)]
    avecountpunish10 = [(a) for a in zip(*allcountpunish10)]
    avecountsupport10 = [(a) for a in zip(*allcountsupport10)]
    avetotalsupport10 = [(a) for a in zip(*alltotalsupport10)]
    avecountdefend10 = [(a) for a in zip(*allcountdefend10)]

    avestrength11 = [(a) for a in zip(*allstrength11)]
    avenotorietyratio11 = [(a) for a in zip(*allnotorietyratio11)]
    avetotalextort11 = [(a) for a in zip(*alltotalextort11)]
    avecountextort11 = [(a) for a in zip(*allcountextort11)]
    avecountbenefit11 = [(a) for a in zip(*allcountbenefit11)]
    avecountpunish11 = [(a) for a in zip(*allcountpunish11)]
    avecountsupport11 = [(a) for a in zip(*allcountsupport11)]
    avetotalsupport11 = [(a) for a in zip(*alltotalsupport11)]
    avecountdefend11 = [(a) for a in zip(*allcountdefend11)]

    avestrength12 = [(a) for a in zip(*allstrength12)]
    avenotorietyratio12 = [(a) for a in zip(*allnotorietyratio12)]
    avetotalextort12 = [(a) for a in zip(*alltotalextort12)]
    avecountextort12 = [(a) for a in zip(*allcountextort12)]
    avecountbenefit12 = [(a) for a in zip(*allcountbenefit12)]
    avecountpunish12 = [(a) for a in zip(*allcountpunish12)]
    avecountsupport12 = [(a) for a in zip(*allcountsupport12)]
    avetotalsupport12 = [(a) for a in zip(*alltotalsupport12)]
    avecountdefend12 = [(a) for a in zip(*allcountdefend12)]

    avestrength13 = [(a) for a in zip(*allstrength13)]
    avenotorietyratio13 = [(a) for a in zip(*allnotorietyratio13)]
    avetotalextort13 = [(a) for a in zip(*alltotalextort13)]
    avecountextort13 = [(a) for a in zip(*allcountextort13)]
    avecountbenefit13 = [(a) for a in zip(*allcountbenefit13)]
    avecountpunish13 = [(a) for a in zip(*allcountpunish13)]
    avecountsupport13 = [(a) for a in zip(*allcountsupport13)]
    avetotalsupport13 = [(a) for a in zip(*alltotalsupport13)]
    avecountdefend13 = [(a) for a in zip(*allcountdefend13)]

    avestrength14 = [(a) for a in zip(*allstrength14)]
    avenotorietyratio14 = [(a) for a in zip(*allnotorietyratio14)]
    avetotalextort14 = [(a) for a in zip(*alltotalextort14)]
    avecountextort14 = [(a) for a in zip(*allcountextort14)]
    avecountbenefit14 = [(a) for a in zip(*allcountbenefit14)]
    avecountpunish14 = [(a) for a in zip(*allcountpunish14)]
    avecountsupport14 = [(a) for a in zip(*allcountsupport14)]
    avetotalsupport14 = [(a) for a in zip(*alltotalsupport14)]
    avecountdefend14 = [(a) for a in zip(*allcountdefend14)]

    avestrength15 = [(a) for a in zip(*allstrength15)]
    avenotorietyratio15 = [(a) for a in zip(*allnotorietyratio15)]
    avetotalextort15 = [(a) for a in zip(*alltotalextort15)]
    avecountextort15 = [(a) for a in zip(*allcountextort15)]
    avecountbenefit15 = [(a) for a in zip(*allcountbenefit15)]
    avecountpunish15 = [(a) for a in zip(*allcountpunish15)]
    avecountsupport15 = [(a) for a in zip(*allcountsupport15)]
    avetotalsupport15 = [(a) for a in zip(*alltotalsupport15)]
    avecountdefend15 = [(a) for a in zip(*allcountdefend15)]

    avecommunity1m1 = [(a) for a in zip(*allcommunity1m1)]
    avecommunity2m1 = [(a) for a in zip(*allcommunity2m1)]
    avecommunity3m1 = [(a) for a in zip(*allcommunity3m1)]
    avecommunity4m1 = [(a) for a in zip(*allcommunity4m1)]
    avecommunity5m1 = [(a) for a in zip(*allcommunity5m1)]
    avecommunity6m1 = [(a) for a in zip(*allcommunity6m1)]
    avecommunity7m1 = [(a) for a in zip(*allcommunity7m1)]
    avecommunity8m1 = [(a) for a in zip(*allcommunity8m1)]
    avecommunity9m1 = [(a) for a in zip(*allcommunity9m1)]
    avecommunity10m1 = [(a) for a in zip(*allcommunity10m1)]
    avecommunity11m1 = [(a) for a in zip(*allcommunity11m1)]
    avecommunity12m1 = [(a) for a in zip(*allcommunity12m1)]
    avecommunity13m1 = [(a) for a in zip(*allcommunity13m1)]
    avecommunity14m1 = [(a) for a in zip(*allcommunity14m1)]
    avecommunity15m1 = [(a) for a in zip(*allcommunity15m1)]

    avecommunity1m2 = [(a) for a in zip(*allcommunity1m2)]
    avecommunity2m2 = [(a) for a in zip(*allcommunity2m2)]
    avecommunity3m2 = [(a) for a in zip(*allcommunity3m2)]
    avecommunity4m2 = [(a) for a in zip(*allcommunity4m2)]
    avecommunity5m2 = [(a) for a in zip(*allcommunity5m2)]
    avecommunity6m2 = [(a) for a in zip(*allcommunity6m2)]
    avecommunity7m2 = [(a) for a in zip(*allcommunity7m2)]
    avecommunity8m2 = [(a) for a in zip(*allcommunity8m2)]
    avecommunity9m2 = [(a) for a in zip(*allcommunity9m2)]
    avecommunity10m2 = [(a) for a in zip(*allcommunity10m2)]
    avecommunity11m2 = [(a) for a in zip(*allcommunity11m2)]
    avecommunity12m2 = [(a) for a in zip(*allcommunity12m2)]
    avecommunity13m2 = [(a) for a in zip(*allcommunity13m2)]
    avecommunity14m2 = [(a) for a in zip(*allcommunity14m2)]
    avecommunity15m2 = [(a) for a in zip(*allcommunity15m2)]

    avecommunity1m3 = [(a) for a in zip(*allcommunity1m3)]
    avecommunity2m3 = [(a) for a in zip(*allcommunity2m3)]
    avecommunity3m3 = [(a) for a in zip(*allcommunity3m3)]
    avecommunity4m3 = [(a) for a in zip(*allcommunity4m3)]
    avecommunity5m3 = [(a) for a in zip(*allcommunity5m3)]
    avecommunity6m3 = [(a) for a in zip(*allcommunity6m3)]
    avecommunity7m3 = [(a) for a in zip(*allcommunity7m3)]
    avecommunity8m3 = [(a) for a in zip(*allcommunity8m3)]
    avecommunity9m3 = [(a) for a in zip(*allcommunity9m3)]
    avecommunity10m3 = [(a) for a in zip(*allcommunity10m3)]
    avecommunity11m3 = [(a) for a in zip(*allcommunity11m3)]
    avecommunity12m3 = [(a) for a in zip(*allcommunity12m3)]
    avecommunity13m3 = [(a) for a in zip(*allcommunity13m3)]
    avecommunity14m3 = [(a) for a in zip(*allcommunity14m3)]
    avecommunity15m3 = [(a) for a in zip(*allcommunity15m3)]

    avecommunity1m4 = [(a) for a in zip(*allcommunity1m4)]
    avecommunity2m4 = [(a) for a in zip(*allcommunity2m4)]
    avecommunity3m4 = [(a) for a in zip(*allcommunity3m4)]
    avecommunity4m4 = [(a) for a in zip(*allcommunity4m4)]
    avecommunity5m4 = [(a) for a in zip(*allcommunity5m4)]
    avecommunity6m4 = [(a) for a in zip(*allcommunity6m4)]
    avecommunity7m4 = [(a) for a in zip(*allcommunity7m4)]
    avecommunity8m4 = [(a) for a in zip(*allcommunity8m4)]
    avecommunity9m4 = [(a) for a in zip(*allcommunity9m4)]
    avecommunity10m4 = [(a) for a in zip(*allcommunity10m4)]
    avecommunity11m4 = [(a) for a in zip(*allcommunity11m4)]
    avecommunity12m4 = [(a) for a in zip(*allcommunity12m4)]
    avecommunity13m4 = [(a) for a in zip(*allcommunity13m4)]
    avecommunity14m4 = [(a) for a in zip(*allcommunity14m4)]
    avecommunity15m4 = [(a) for a in zip(*allcommunity15m4)]

    avecommunity1m5 = [(a) for a in zip(*allcommunity1m5)]
    avecommunity2m5 = [(a) for a in zip(*allcommunity2m5)]
    avecommunity3m5 = [(a) for a in zip(*allcommunity3m5)]
    avecommunity4m5 = [(a) for a in zip(*allcommunity4m5)]
    avecommunity5m5 = [(a) for a in zip(*allcommunity5m5)]
    avecommunity6m5 = [(a) for a in zip(*allcommunity6m5)]
    avecommunity7m5 = [(a) for a in zip(*allcommunity7m5)]
    avecommunity8m5 = [(a) for a in zip(*allcommunity8m5)]
    avecommunity9m5 = [(a) for a in zip(*allcommunity9m5)]
    avecommunity10m5 = [(a) for a in zip(*allcommunity10m5)]
    avecommunity11m5 = [(a) for a in zip(*allcommunity11m5)]
    avecommunity12m5 = [(a) for a in zip(*allcommunity12m5)]
    avecommunity13m5 = [(a) for a in zip(*allcommunity13m5)]
    avecommunity14m5 = [(a) for a in zip(*allcommunity14m5)]
    avecommunity15m5 = [(a) for a in zip(*allcommunity15m5)]

    avecommunity1m6 = [(a) for a in zip(*allcommunity1m6)]
    avecommunity2m6 = [(a) for a in zip(*allcommunity2m6)]
    avecommunity3m6 = [(a) for a in zip(*allcommunity3m6)]
    avecommunity4m6 = [(a) for a in zip(*allcommunity4m6)]
    avecommunity5m6 = [(a) for a in zip(*allcommunity5m6)]
    avecommunity6m6 = [(a) for a in zip(*allcommunity6m6)]
    avecommunity7m6 = [(a) for a in zip(*allcommunity7m6)]
    avecommunity8m6 = [(a) for a in zip(*allcommunity8m6)]
    avecommunity9m6 = [(a) for a in zip(*allcommunity9m6)]
    avecommunity10m6 = [(a) for a in zip(*allcommunity10m6)]
    avecommunity11m6 = [(a) for a in zip(*allcommunity11m6)]
    avecommunity12m6 = [(a) for a in zip(*allcommunity12m6)]
    avecommunity13m6 = [(a) for a in zip(*allcommunity13m6)]
    avecommunity14m6 = [(a) for a in zip(*allcommunity14m6)]
    avecommunity15m6 = [(a) for a in zip(*allcommunity15m6)]

    avecommunity1m7 = [(a) for a in zip(*allcommunity1m7)]
    avecommunity2m7 = [(a) for a in zip(*allcommunity2m7)]
    avecommunity3m7 = [(a) for a in zip(*allcommunity3m7)]
    avecommunity4m7 = [(a) for a in zip(*allcommunity4m7)]
    avecommunity5m7 = [(a) for a in zip(*allcommunity5m7)]
    avecommunity6m7 = [(a) for a in zip(*allcommunity6m7)]
    avecommunity7m7 = [(a) for a in zip(*allcommunity7m7)]
    avecommunity8m7 = [(a) for a in zip(*allcommunity8m7)]
    avecommunity9m7 = [(a) for a in zip(*allcommunity9m7)]
    avecommunity10m7 = [(a) for a in zip(*allcommunity10m7)]
    avecommunity11m7 = [(a) for a in zip(*allcommunity11m7)]
    avecommunity12m7 = [(a) for a in zip(*allcommunity12m7)]
    avecommunity13m7 = [(a) for a in zip(*allcommunity13m7)]
    avecommunity14m7 = [(a) for a in zip(*allcommunity14m7)]
    avecommunity15m7 = [(a) for a in zip(*allcommunity15m7)]

    avecommunity1m8 = [(a) for a in zip(*allcommunity1m8)]
    avecommunity2m8 = [(a) for a in zip(*allcommunity2m8)]
    avecommunity3m8 = [(a) for a in zip(*allcommunity3m8)]
    avecommunity4m8 = [(a) for a in zip(*allcommunity4m8)]
    avecommunity5m8 = [(a) for a in zip(*allcommunity5m8)]
    avecommunity6m8 = [(a) for a in zip(*allcommunity6m8)]
    avecommunity7m8 = [(a) for a in zip(*allcommunity7m8)]
    avecommunity8m8 = [(a) for a in zip(*allcommunity8m8)]
    avecommunity9m8 = [(a) for a in zip(*allcommunity9m8)]
    avecommunity10m8 = [(a) for a in zip(*allcommunity10m8)]
    avecommunity11m8 = [(a) for a in zip(*allcommunity11m8)]
    avecommunity12m8 = [(a) for a in zip(*allcommunity12m8)]
    avecommunity13m8 = [(a) for a in zip(*allcommunity13m8)]
    avecommunity14m8 = [(a) for a in zip(*allcommunity14m8)]
    avecommunity15m8 = [(a) for a in zip(*allcommunity15m8)]

    avecommunity1m9 = [(a) for a in zip(*allcommunity1m9)]
    avecommunity2m9 = [(a) for a in zip(*allcommunity2m9)]
    avecommunity3m9 = [(a) for a in zip(*allcommunity3m9)]
    avecommunity4m9 = [(a) for a in zip(*allcommunity4m9)]
    avecommunity5m9 = [(a) for a in zip(*allcommunity5m9)]
    avecommunity6m9 = [(a) for a in zip(*allcommunity6m9)]
    avecommunity7m9 = [(a) for a in zip(*allcommunity7m9)]
    avecommunity8m9 = [(a) for a in zip(*allcommunity8m9)]
    avecommunity9m9 = [(a) for a in zip(*allcommunity9m9)]
    avecommunity10m9 = [(a) for a in zip(*allcommunity10m9)]
    avecommunity11m9 = [(a) for a in zip(*allcommunity11m9)]
    avecommunity12m9 = [(a) for a in zip(*allcommunity12m9)]
    avecommunity13m9 = [(a) for a in zip(*allcommunity13m9)]
    avecommunity14m9 = [(a) for a in zip(*allcommunity14m9)]
    avecommunity15m9 = [(a) for a in zip(*allcommunity15m9)]

    avecommunity1m10 = [(a) for a in zip(*allcommunity1m10)]
    avecommunity2m10 = [(a) for a in zip(*allcommunity2m10)]
    avecommunity3m10 = [(a) for a in zip(*allcommunity3m10)]
    avecommunity4m10 = [(a) for a in zip(*allcommunity4m10)]
    avecommunity5m10 = [(a) for a in zip(*allcommunity5m10)]
    avecommunity6m10 = [(a) for a in zip(*allcommunity6m10)]
    avecommunity7m10 = [(a) for a in zip(*allcommunity7m10)]
    avecommunity8m10 = [(a) for a in zip(*allcommunity8m10)]
    avecommunity9m10 = [(a) for a in zip(*allcommunity9m10)]
    avecommunity10m10 = [(a) for a in zip(*allcommunity10m10)]
    avecommunity11m10 = [(a) for a in zip(*allcommunity11m10)]
    avecommunity12m10 = [(a) for a in zip(*allcommunity12m10)]
    avecommunity13m10 = [(a) for a in zip(*allcommunity13m10)]
    avecommunity14m10 = [(a) for a in zip(*allcommunity14m10)]
    avecommunity15m10 = [(a) for a in zip(*allcommunity15m10)]

    avecommunity1m11 = [(a) for a in zip(*allcommunity1m11)]
    avecommunity2m11 = [(a) for a in zip(*allcommunity2m11)]
    avecommunity3m11 = [(a) for a in zip(*allcommunity3m11)]
    avecommunity4m11 = [(a) for a in zip(*allcommunity4m11)]
    avecommunity5m11 = [(a) for a in zip(*allcommunity5m11)]
    avecommunity6m11 = [(a) for a in zip(*allcommunity6m11)]
    avecommunity7m11 = [(a) for a in zip(*allcommunity7m11)]
    avecommunity8m11 = [(a) for a in zip(*allcommunity8m11)]
    avecommunity9m11 = [(a) for a in zip(*allcommunity9m11)]
    avecommunity10m11 = [(a) for a in zip(*allcommunity10m11)]
    avecommunity11m11 = [(a) for a in zip(*allcommunity11m11)]
    avecommunity12m11 = [(a) for a in zip(*allcommunity12m11)]
    avecommunity13m11 = [(a) for a in zip(*allcommunity13m11)]
    avecommunity14m11 = [(a) for a in zip(*allcommunity14m11)]
    avecommunity15m11 = [(a) for a in zip(*allcommunity15m11)]

    avecommunity1m12 = [(a) for a in zip(*allcommunity1m12)]
    avecommunity2m12 = [(a) for a in zip(*allcommunity2m12)]
    avecommunity3m12 = [(a) for a in zip(*allcommunity3m12)]
    avecommunity4m12 = [(a) for a in zip(*allcommunity4m12)]
    avecommunity5m12 = [(a) for a in zip(*allcommunity5m12)]
    avecommunity6m12 = [(a) for a in zip(*allcommunity6m12)]
    avecommunity7m12 = [(a) for a in zip(*allcommunity7m12)]
    avecommunity8m12 = [(a) for a in zip(*allcommunity8m12)]
    avecommunity9m12 = [(a) for a in zip(*allcommunity9m12)]
    avecommunity10m12 = [(a) for a in zip(*allcommunity10m12)]
    avecommunity11m12 = [(a) for a in zip(*allcommunity11m12)]
    avecommunity12m12 = [(a) for a in zip(*allcommunity12m12)]
    avecommunity13m12 = [(a) for a in zip(*allcommunity13m12)]
    avecommunity14m12 = [(a) for a in zip(*allcommunity14m12)]
    avecommunity15m12 = [(a) for a in zip(*allcommunity15m12)]

    avecommunity1m13 = [(a) for a in zip(*allcommunity1m13)]
    avecommunity2m13 = [(a) for a in zip(*allcommunity2m13)]
    avecommunity3m13 = [(a) for a in zip(*allcommunity3m13)]
    avecommunity4m13 = [(a) for a in zip(*allcommunity4m13)]
    avecommunity5m13 = [(a) for a in zip(*allcommunity5m13)]
    avecommunity6m13 = [(a) for a in zip(*allcommunity6m13)]
    avecommunity7m13 = [(a) for a in zip(*allcommunity7m13)]
    avecommunity8m13 = [(a) for a in zip(*allcommunity8m13)]
    avecommunity9m13 = [(a) for a in zip(*allcommunity9m13)]
    avecommunity10m13 = [(a) for a in zip(*allcommunity10m13)]
    avecommunity11m13 = [(a) for a in zip(*allcommunity11m13)]
    avecommunity12m13 = [(a) for a in zip(*allcommunity12m13)]
    avecommunity13m13 = [(a) for a in zip(*allcommunity13m13)]
    avecommunity14m13 = [(a) for a in zip(*allcommunity14m13)]
    avecommunity15m13 = [(a) for a in zip(*allcommunity15m13)]

    avecommunity1m14 = [(a) for a in zip(*allcommunity1m14)]
    avecommunity2m14 = [(a) for a in zip(*allcommunity2m14)]
    avecommunity3m14 = [(a) for a in zip(*allcommunity3m14)]
    avecommunity4m14 = [(a) for a in zip(*allcommunity4m14)]
    avecommunity5m14 = [(a) for a in zip(*allcommunity5m14)]
    avecommunity6m14 = [(a) for a in zip(*allcommunity6m14)]
    avecommunity7m14 = [(a) for a in zip(*allcommunity7m14)]
    avecommunity8m14 = [(a) for a in zip(*allcommunity8m14)]
    avecommunity9m14 = [(a) for a in zip(*allcommunity9m14)]
    avecommunity10m14 = [(a) for a in zip(*allcommunity10m14)]
    avecommunity11m14 = [(a) for a in zip(*allcommunity11m14)]
    avecommunity12m14 = [(a) for a in zip(*allcommunity12m14)]
    avecommunity13m14 = [(a) for a in zip(*allcommunity13m14)]
    avecommunity14m14 = [(a) for a in zip(*allcommunity14m14)]
    avecommunity15m14 = [(a) for a in zip(*allcommunity15m14)]

    avecommunity1m15 = [(a) for a in zip(*allcommunity1m15)]
    avecommunity2m15 = [(a) for a in zip(*allcommunity2m15)]
    avecommunity3m15 = [(a) for a in zip(*allcommunity3m15)]
    avecommunity4m15 = [(a) for a in zip(*allcommunity4m15)]
    avecommunity5m15 = [(a) for a in zip(*allcommunity5m15)]
    avecommunity6m15 = [(a) for a in zip(*allcommunity6m15)]
    avecommunity7m15 = [(a) for a in zip(*allcommunity7m15)]
    avecommunity8m15 = [(a) for a in zip(*allcommunity8m15)]
    avecommunity9m15 = [(a) for a in zip(*allcommunity9m15)]
    avecommunity10m15 = [(a) for a in zip(*allcommunity10m15)]
    avecommunity11m15 = [(a) for a in zip(*allcommunity11m15)]
    avecommunity12m15 = [(a) for a in zip(*allcommunity12m15)]
    avecommunity13m15 = [(a) for a in zip(*allcommunity13m15)]
    avecommunity14m15 = [(a) for a in zip(*allcommunity14m15)]
    avecommunity15m15 = [(a) for a in zip(*allcommunity15m15)]

    avecommunity1defend = [(a) for a in zip(*allcommunity1defend)]
    avecommunity2defend = [(a) for a in zip(*allcommunity2defend)]
    avecommunity3defend = [(a) for a in zip(*allcommunity3defend)]
    avecommunity4defend = [(a) for a in zip(*allcommunity4defend)]
    avecommunity5defend = [(a) for a in zip(*allcommunity5defend)]
    avecommunity6defend = [(a) for a in zip(*allcommunity6defend)]
    avecommunity7defend = [(a) for a in zip(*allcommunity7defend)]
    avecommunity8defend = [(a) for a in zip(*allcommunity8defend)]
    avecommunity9defend = [(a) for a in zip(*allcommunity9defend)]
    avecommunity10defend = [(a) for a in zip(*allcommunity10defend)]
    avecommunity11defend = [(a) for a in zip(*allcommunity11defend)]
    avecommunity12defend = [(a) for a in zip(*allcommunity12defend)]
    avecommunity13defend = [(a) for a in zip(*allcommunity13defend)]
    avecommunity14defend = [(a) for a in zip(*allcommunity14defend)]
    avecommunity15defend = [(a) for a in zip(*allcommunity15defend)]

    aveoneandtwo = [(a) for a in zip(*alloneandtwo)]
    aveoneandthree = [(a) for a in zip(*alloneandthree)]
    avetwoandthree = [(a) for a in zip(*alltwoandthree)]

    aveoneandtwo = [(a) for a in zip(*alloneandtwo)]
    aveoneandthree = [(a) for a in zip(*alloneandthree)]
    aveoneandfour = [(a) for a in zip(*alloneandfour)]
    aveoneandfive = [(a) for a in zip(*alloneandfive)]
    aveoneandsix = [(a) for a in zip(*alloneandsix)]
    aveoneandseven = [(a) for a in zip(*alloneandseven)]
    aveoneandeight = [(a) for a in zip(*alloneandeight)]
    aveoneandnine = [(a) for a in zip(*alloneandnine)]
    aveoneandten = [(a) for a in zip(*alloneandten)]
    aveoneandeleven = [(a) for a in zip(*alloneandeleven)]
    aveoneandtwelve = [(a) for a in zip(*alloneandtwelve)]
    aveoneandthirteen = [(a) for a in zip(*alloneandthirteen)]
    aveoneandfourteen = [(a) for a in zip(*alloneandfourteen)]
    aveoneandfifteen = [(a) for a in zip(*alloneandfifteen)]

    avetwoandthree = [(a) for a in zip(*alltwoandthree)]
    avetwoandfour = [(a) for a in zip(*alltwoandfour)]
    avetwoandfive = [(a) for a in zip(*alltwoandfive)]
    avetwoandsix = [(a) for a in zip(*alltwoandsix)]
    avetwoandseven = [(a) for a in zip(*alltwoandseven)]
    avetwoandeight = [(a) for a in zip(*alltwoandeight)]
    avetwoandnine = [(a) for a in zip(*alltwoandnine)]
    avetwoandten = [(a) for a in zip(*alltwoandten)]
    avetwoandeleven = [(a) for a in zip(*alltwoandeleven)]
    avetwoandtwelve = [(a) for a in zip(*alltwoandtwelve)]
    avetwoandthirteen = [(a) for a in zip(*alltwoandthirteen)]
    avetwoandfourteen = [(a) for a in zip(*alltwoandfourteen)]
    avetwoandfifteen = [(a) for a in zip(*alltwoandfifteen)]

    avethreeandfour = [(a) for a in zip(*allthreeandfour)]
    avethreeandfive = [(a) for a in zip(*allthreeandfive)]
    avethreeandsix = [(a) for a in zip(*allthreeandsix)]
    avethreeandseven = [(a) for a in zip(*allthreeandseven)]
    avethreeandeight = [(a) for a in zip(*allthreeandeight)]
    avethreeandnine = [(a) for a in zip(*allthreeandnine)]
    avethreeandten = [(a) for a in zip(*allthreeandten)]
    avethreeandeleven = [(a) for a in zip(*allthreeandeleven)]
    avethreeandtwelve = [(a) for a in zip(*allthreeandtwelve)]
    avethreeandthirteen = [(a) for a in zip(*allthreeandthirteen)]
    avethreeandfourteen = [(a) for a in zip(*allthreeandfourteen)]
    avethreeandfifteen = [(a) for a in zip(*allthreeandfifteen)]

    avefourandfive = [(a) for a in zip(*allfourandfive)]
    avefourandsix = [(a) for a in zip(*allfourandsix)]
    avefourandseven = [(a) for a in zip(*allfourandseven)]
    avefourandeight = [(a) for a in zip(*allfourandeight)]
    avefourandnine = [(a) for a in zip(*allfourandnine)]
    avefourandten = [(a) for a in zip(*allfourandten)]
    avefourandeleven = [(a) for a in zip(*allfourandeleven)]
    avefourandtwelve = [(a) for a in zip(*allfourandtwelve)]
    avefourandthirteen = [(a) for a in zip(*allfourandthirteen)]
    avefourandfourteen = [(a) for a in zip(*allfourandfourteen)]
    avefourandfifteen = [(a) for a in zip(*allfourandfifteen)]

    avefiveandsix = [(a) for a in zip(*allfiveandsix)]
    avefiveandseven = [(a) for a in zip(*allfiveandseven)]
    avefiveandeight = [(a) for a in zip(*allfiveandeight)]
    avefiveandnine = [(a) for a in zip(*allfiveandnine)]
    avefiveandten = [(a) for a in zip(*allfiveandten)]
    avefiveandeleven = [(a) for a in zip(*allfiveandeleven)]
    avefiveandtwelve = [(a) for a in zip(*allfiveandtwelve)]
    avefiveandthirteen = [(a) for a in zip(*allfiveandthirteen)]
    avefiveandfourteen = [(a) for a in zip(*allfiveandfourteen)]
    avefiveandfifteen = [(a) for a in zip(*allfiveandfifteen)]

    avesixandseven = [(a) for a in zip(*allsixandseven)]
    avesixandeight = [(a) for a in zip(*allsixandeight)]
    avesixandnine = [(a) for a in zip(*allsixandnine)]
    avesixandten = [(a) for a in zip(*allsixandten)]
    avesixandeleven = [(a) for a in zip(*allsixandeleven)]
    avesixandtwelve = [(a) for a in zip(*allsixandtwelve)]
    avesixandthirteen = [(a) for a in zip(*allsixandthirteen)]
    avesixandfourteen = [(a) for a in zip(*allsixandfourteen)]
    avesixandfifteen = [(a) for a in zip(*allsixandfifteen)]

    avesevenandeight = [(a) for a in zip(*allsevenandeight)]
    avesevenandnine = [(a) for a in zip(*allsevenandnine)]
    avesevenandten = [(a) for a in zip(*allsevenandten)]
    avesevenandeleven = [(a) for a in zip(*allsevenandeleven)]
    avesevenandtwelve = [(a) for a in zip(*allsevenandtwelve)]
    avesevenandthirteen = [(a) for a in zip(*allsevenandthirteen)]
    avesevenandfourteen = [(a) for a in zip(*allsevenandfourteen)]
    avesevenandfifteen = [(a) for a in zip(*allsevenandfifteen)]

    aveeightandnine = [(a) for a in zip(*alleightandnine)]
    aveeightandten = [(a) for a in zip(*alleightandten)]
    aveeightandeleven = [(a) for a in zip(*alleightandeleven)]
    aveeightandtwelve = [(a) for a in zip(*alleightandtwelve)]
    aveeightandthirteen = [(a) for a in zip(*alleightandthirteen)]
    aveeightandfourteen = [(a) for a in zip(*alleightandfourteen)]
    aveeightandfifteen = [(a) for a in zip(*alleightandfifteen)]

    avenineandten = [(a) for a in zip(*allnineandten)]
    avenineandeleven = [(a) for a in zip(*allnineandeleven)]
    avenineandtwelve = [(a) for a in zip(*allnineandtwelve)]
    avenineandthirteen = [(a) for a in zip(*allnineandthirteen)]
    avenineandfourteen = [(a) for a in zip(*allnineandfourteen)]
    avenineandfifteen = [(a) for a in zip(*allnineandfifteen)]

    avetenandeleven = [(a) for a in zip(*alltenandeleven)]
    avetenandtwelve = [(a) for a in zip(*alltenandtwelve)]
    avetenandthirteen = [(a) for a in zip(*alltenandthirteen)]
    avetenandfourteen = [(a) for a in zip(*alltenandfourteen)]
    avetenandfifteen = [(a) for a in zip(*alltenandfifteen)]

    aveelevenandtwelve = [(a) for a in zip(*allelevenandtwelve)]
    aveelevenandthirteen = [(a) for a in zip(*allelevenandthirteen)]
    aveelevenandfourteen = [(a) for a in zip(*allelevenandfourteen)]
    aveelevenandfifteen = [(a) for a in zip(*allelevenandfifteen)]

    avetwelveandthirteen = [(a) for a in zip(*alltwelveandthirteen)]
    avetwelveandfourteen = [(a) for a in zip(*alltwelveandfourteen)]
    avetwelveandfifteen = [(a) for a in zip(*alltwelveandfifteen)]

    avethirteenandfourteen = [(a) for a in zip(*allthirteenandfourteen)]
    avethirteenandfifteen = [(a) for a in zip(*allthirteenandfifteen)]
    avefourteenandfifteen = [(a) for a in zip(*allfourteenandfifteen)]
