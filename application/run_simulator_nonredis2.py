...
from application.model.results import fetchoutput
...
def simulator2():
    ...
    i = 1
    modelresults = fetchoutput(i)

    # print('strength sim', i, ':', modelresults[0][0])
...
# data = simulator2()
# plt.figure(0)
# plt.plot(data['rounds'], data['strength1'], label='militant1')
# plt.plot(data['rounds'], data['strength2'], label='militant2')
# plt.plot(data['rounds'], data['strength3'], label='militant3')
# plt.xlabel('t')
# plt.ylabel('strength')
...
# plt.figure(0)
# plt.plot(data['rounds'], data['oneandtwo'], label='oneandtwo')
# plt.plot(data['rounds'], data['oneandthree'], label='oneandthree')
# plt.plot(data['rounds'], data['twoandthree'], label='twoandthree')
# plt.xlabel('t')
# plt.ylabel('fighting')
# plt.title("Fighting")
# plt.legend()
...
# plt.figure(2)
# plt.plot(data['rounds'], data['community1defend'], label='community1defend')
# plt.plot(data['rounds'], data['community2defend'], label='community2defend')
# plt.plot(data['rounds'], data['community3defend'], label='community3defend')
# plt.xlabel('t')
