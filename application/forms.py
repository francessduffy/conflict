...
class FourthForm(FlaskForm):
    ...
    def __init__(self, labels=None, **kwargs):
        super().__init__(**kwargs)
        if labels is None:
            labels = ['1. List the names of any militants that the intervention supports, separated by a comma:', '2. List the names of any militants that the intervention opposes, separated by a comma:', 'Negotiate disputes between all communities:', 'Hold negotiations between two militant groups:', 'First Militant:', 'Second Militant:', 'Wage information campaign:', 'Support militant governance:', 'Increase civilian wealth:', 'List regions separated by a comma:', 'List communities separated by a comma:', 'Provide community leaders with benefits:', 'Provide militants with benefits to pass to civilians:', 'Provide civilians with benefits conditional on ceasing militant support:', 'Fund supported militants:', 'Amount of funding:', 'Cut off resources from opposed militants:', 'Percent of resources to cut off (decimal form):', 'Attack opposed militants:', 'Punish civilian support of opposed militants:', 'Remove available weapons:', 'List regions separated by a comma:', 'Provide training and equipment to supported militants:', 'Protect civilians from opposed militants:']
