from application.model.initconditions import commsuppstdv, communitylist, scatter
from application.model.community import totalcommunity, totalcommunitysupport
import random
