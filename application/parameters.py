...
def get_parameters():
    try:
        form1 = pd.read_csv('/opt/python/current/app/application/static/form1.csv')
        regionvalues = pd.read_csv('/opt/python/current/app/application/static/regionvalues.csv')
        communityvalues = pd.read_csv('/opt/python/current/app/application/static/communityvalues.csv')
        militantvalues = pd.read_csv('/opt/python/current/app/application/static/militantvalues.csv')
        communitypercents = pd.read_csv('/opt/python/current/app/application/static/communitypercents.csv')
        boxlist = pd.read_csv('/opt/python/current/app/application/static/boxlist.csv')
        boxmlist = pd.read_csv('/opt/python/current/app/application/static/boxmlist.csv')
        militantregionlist = pd.read_csv('/opt/python/current/app/application/static/militantregionlist.csv')
    except FileNotFoundError:
        form1 = pd.read_csv('http://interventionsimulator.us-east-1.elasticbeanstalk.com/static/form1.csv')
        regionvalues = pd.read_csv('http://interventionsimulator.us-east-1.elasticbeanstalk.com/static/regionvalues.csv')
        communityvalues = pd.read_csv('http://interventionsimulator.us-east-1.elasticbeanstalk.com/static/communityvalues.csv')
        militantvalues = pd.read_csv('http://interventionsimulator.us-east-1.elasticbeanstalk.com/static/militantvalues.csv')
        communitypercents = pd.read_csv('http://interventionsimulator.us-east-1.elasticbeanstalk.com/static/communitypercents.csv')
        boxlist = pd.read_csv('http://interventionsimulator.us-east-1.elasticbeanstalk.com/static/boxlist.csv')
        boxmlist = pd.read_csv('http://interventionsimulator.us-east-1.elasticbeanstalk.com/static/boxmlist.csv')
        militantregionlist = pd.read_csv('http://interventionsimulator.us-east-1.elasticbeanstalk.com/static/militantregionlist.csv')
        # Use this block of code for local deployment only
        # form1 = pd.read_csv('/Users/Frances/python/conflict/application/static/form1.csv')
        # regionvalues = pd.read_csv('/Users/Frances/python/conflict/application/static/regionvalues.csv')
        # communityvalues = pd.read_csv('/Users/Frances/python/conflict/application/static/communityvalues.csv')
        # militantvalues = pd.read_csv('/Users/Frances/python/conflict/application/static/militantvalues.csv')
        # communitypercents = pd.read_csv('/Users/Frances/python/conflict/application/static/communitypercents.csv')
        # boxlist = pd.read_csv('/Users/Frances/python/conflict/application/static/boxlist.csv')
        # boxmlist = pd.read_csv('/Users/Frances/python/conflict/application/static/boxmlist.csv')
        # militantregionlist = pd.read_csv('/Users/Frances/python/conflict/application/static/militantregionlist.csv')
